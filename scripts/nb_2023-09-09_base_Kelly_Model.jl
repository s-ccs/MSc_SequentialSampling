...
# ╔═╡ a41ea2bc-9fff-47db-b455-27945daf8254
...
begin
	reset
allSliders = PlutoExtras.StructBondModule.@BondsList "" let
...
# ╔═╡ 009c5519-0c80-48b7-84ae-d8f3330dce5c
eeg
...
# Assuming `c` is the data frame used for plotting
c.basisname = CategoricalArray(c.basisname; levels=["stimulus", "response"]) # reverse the order
c.group = CategoricalArray(c.group; levels=["erp", "deconv"])
# Now when you plot, it should reflect the swapped order
plot_erp(c; mapping=(; color=:condition, col=:basisname, row=:group))
...
series(range(0,step=1/fs,length=801),cpp1[ch.==1,:],solid_color=RGBAf(0,0,0,0.1))

# ╔═╡ 2f67da03-95c1-40e1-ba28-86f67c320e08
#=>sorter(["stimulus","response"])
#=>sorter(["erp","deconv"]))
...
manifest_format = "2.0"
project_hash = "7b1d0251c7991c05299763019d34f664ac6d9fbc"
...
git-tree-sha1 = "a67a194c71cd51d39d0f0421ab747d8eac728727"
...
git-tree-sha1 = "4a374a26fed6372da6a6805a999e3355a2315fdc"
...
git-tree-sha1 = "67732df8d2f9c49a39fcac81d03f6139b4e68422"
